...
parser.add_argument('-b','--boxfile', help='boxfile, required argument, use --boxfile=fullfield if you want to subtract the entire field', required=True, type=str)
