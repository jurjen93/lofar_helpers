...
if __name__ == '__main__':
    ...
    opt.add_option('-c', '--complevel',
                   help='Compression level from 0 (no compression, fast) to 9 (max compression, slow) (default=5)',
                   type='int', default='5')
    opt.add_option('--nofulljones', help='Export the solutions as just XX/YY instead of XX,XY,YX,YY.',
                   action='store_false', dest='fulljones', default=True)
