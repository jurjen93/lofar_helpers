...
singularity exec -B ${SING_BIND} ${SING_IMAGE} python ${SCRIPT_FOLDER}/runwscleanLBautoR.py -b ${TO}/boxes/box_${N}.reg --auto --imager=DDFACET --helperscriptspath ${SCRIPT_FOLDER}/ --autofrequencyaverage-calspeedup box_${N}.dysco.sub.shift.avg.weights.ms.archive0.goodtimes
