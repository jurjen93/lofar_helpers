    ...
    for N, SUBBOX in enumerate(box_archives):
        ...
        cml=[
            "cd TO/selfcal/",
             ...
             "singularity exec -B +"+SING_BIND+" "+SING_IMAGE+" "+" python SCRIPT_PATH/runwscleanLBautoR.py -b TO/boxes/"+BOX+".reg --auto --imager=DDFACET --helperscriptspath=SCRIPT_PATH/ --autofrequencyaverage-calspeedup='True' TO/selfcal/"+BOX+"/"+SUBBOX.split('/')[-1]
             ]
