...
mkdir /net/tussenrijn/data2/jurjendejong/A399_extracted
singularity exec -B ${SING_BIND} /net/rijn/data2/rvweeren/data/pill-latest.simg python ${SCRIPT_FOLDER}/move_files/move_extract_files.py --frm /net/rijn/data2/jdejong/A399_DEEP --to /net/tussenrijn/data2/jurjendejong/A399_extracted
cd /net/tussenrijn/data2/jurjendejong/A399_extracted
...
rm -rf /net/tussenrijn/data2/jurjendejong/A399_extracted/L6*.ms
rm -rf /net/tussenrijn/data2/jurjendejong/A399_extracted/L6*.ms.archive
