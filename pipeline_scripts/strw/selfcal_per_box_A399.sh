...
singularity exec -B ${SING_BIND} ${SING_IMAGE} python ${SCRIPT_FOLDER}/runwscleanLBautoR.py -b box_${BOX}.reg --auto --imager=DDFACET --helperscriptspath=/net/rijn/data2/rvweeren/LoTSS_ClusterCAL --autofrequencyaverage-calspeedup='True' *box_${BOX}.dysco.sub.shift.avg.weights.ms.archive*