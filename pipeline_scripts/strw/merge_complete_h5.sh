...
singularity exec -B ${SING_BIND} ${SING_IMAGE} python ${SCRIPT_FOLDER}/h5_helpers/h5_filter.py -f ${FOLDER}/extract/image_full_ampphase_di_m.NS.app.restored.fits -ac 2.2 -in false -h5out lotss_merged_filtered.h5 -h5in ${OUTPUT_FOLDER}/lotss_merged.h5
singularity exec -B ${SING_BIND} ${SING_IMAGE} python ${SCRIPT_FOLDER}/h5_helpers/h5_filter.py -f ${FOLDER}/extract/image_full_ampphase_di_m.NS.app.restored.fits -ac 2.2 -in false -h5out lotss_smoothed_filtered.h5 -h5in ${OUTPUT_FOLDER}/lotss_smoothed.h5
