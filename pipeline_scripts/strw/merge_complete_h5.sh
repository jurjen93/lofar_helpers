...
singularity exec -B ${SING_BIND} ${SING_IMAGE} python ${SCRIPT_FOLDER}/h5_merger.py -out lotss_full_merged.h5 -in lotss_*.h5 --convert_tec 0
#-ms '/net/tussenrijn/data2/jurjendejong/L626678/extract/*.archive0'
