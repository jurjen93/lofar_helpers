...
mv ${NAME}_compact-0000-model-pb.fits ${NAME}_compactmask-0000-model.fits
mv ${NAME}_compact-0001-model-pb.fits ${NAME}_compactmask-0001-model.fits
mv ${NAME}_compact-0002-model-pb.fits ${NAME}_compactmask-0002-model.fits
mv ${NAME}_compact-0003-model-pb.fits ${NAME}_compactmask-0003-model.fits
mv ${NAME}_compact-0004-model-pb.fits ${NAME}_compactmask-0004-model.fits
mv ${NAME}_compact-0005-model-pb.fits ${NAME}_compactmask-0005-model.fits
