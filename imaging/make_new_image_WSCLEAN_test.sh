...
#cp ${FROM}/${H5} ${TO}
#cp -r ${FROM}/${MS} ${TO}
singularity exec -B ${SING_BIND} ${SING_IMAGE} python /net/rijn/data2/rvweeren/LoTSS_ClusterCAL/ds9facetgenerator.py --h5 ${H5} --DS9regionout ${TO}/tess.reg --imsize 6000 --ms ${TO}/${MS}
singularity exec -B ${SING_BIND} ${SING_IMAGE_WSCLEAN} python ~/scripts/lofar_helpers/imaging/make_new_image_WSCLEAN_test.py --N ${N}