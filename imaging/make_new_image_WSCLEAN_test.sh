...
cp ${FROM}/${H5} ${TO}
cp -r ${FROM}/${MS} ${TO}
singularity exec -B ${SING_BIND} ${SING_IMAGE} python /net/rijn/data2/rvweeren/LoTSS_ClusterCAL/ds9facetgenerator.py --h5 ${H5} --DS9regionout ${TO}/tess.reg --imsize 6000 --ms ${MS}
