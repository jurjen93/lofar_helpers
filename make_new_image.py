...
os.system('{SINGULARITY} /bin/sh /home/jurjendejong/scripts/lofar_helpers/pipeline_scripts/strw/merge_complete_h5.sh L626678'.format(SINGULARITY=SINGULARITY))
