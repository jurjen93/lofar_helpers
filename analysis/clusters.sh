...
python analysis/make_corr_images.py -filein ptp_dir/A399/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/A399corr.png -no_y -noisefits ${F} > a399results_rudnick.txt
...
python analysis/make_corr_images.py -filein ptp_dir/A401/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/A401corr.png -no_y -noisefits ${F} > a401results_rudnick.txt
...
python analysis/make_corr_images.py -filein ptp_dir/bridge/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/bridgecorr.png -no_y -noisefits ${F} > bridgeresults_rudnick.txt
...
python analysis/make_corr_images.py -filein ptp_dir/A399/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/A399corr.png -no_y -noisefits ${F} > a399results_cb.txt
...
python analysis/make_corr_images.py -filein ptp_dir/A401/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/A401corr.png -no_y -noisefits ${F} > a401results_cb.txt
...
python analysis/make_corr_images.py -filein ptp_dir/bridge/grid_${CELLSIZE}x${CELLSIZE}_results.fits -fileout analysis/bridgecorr.png -no_y -noisefits ${F} > bridgeresults_cb.txt
