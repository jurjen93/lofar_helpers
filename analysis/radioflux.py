"""
Taken from https://github.com/mhardcastle/radioflux/blob/master/radioflux/radioflux.py
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--foreground', dest='fgr', action='store', default='ds9.reg',
                        help='Foreground region file to use')
    parser.add_argument('-b', '--background', dest='bgr', action='store', default='',
                        help='Background region file to use')
    parser.add_argument('-i', '--individual', dest='indiv', action='store_true', default=False,
                        help='Break composite region file into individual regions')
    parser.add_argument('-s', '--subtract', dest='bgsub', action='store_true', default=False,
